 ...
 *
 * @description
 * `menu-and-drawer-close` is an attribute directive that closes a currently opened side menu.
 ...
 *
 * ```html
 * <a menu-and-drawer-close href="#/home" class="item">Home</a>
 * ```
 *
 ...
 *    <!-- Toggle left side menu -->
 *    <button menu-and-drawer-toggle="left" class="button button-icon icon ion-navicon"></button>
 *   </ion-nav-buttons>
 *   <ion-nav-buttons side="right">
 *    <!-- Toggle right side menu -->
 *    <button menu-and-drawer-toggle="right" class="button button-icon icon ion-navicon"></button>
 *   </ion-nav-buttons>
 * </ion-nav-bar>
 * ```
 *
 ...
 * directive. The `menu-and-drawer-close` attribute is usually added to links and buttons within
 ...
 * attribute directive. Clicking the toggle will open and close the side menu like the `menu-and-drawer-close`
