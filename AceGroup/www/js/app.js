...
angular.module('starter', ['ionic', 'starter.controllers','ngCordova','ionic.ui.superSlideBox'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('login', {
    url: '/login',
    templateUrl: 'templates/loginAceGroup.html',
  ...
  .state('app.pedidos', {
    ...
    views: {
      'menuContent': {
        ...
        controller: 'PedidosVerificadosCtrl'
      }
    }
  })
  ...
  .state('app.rastreos', {
    ...
    views: {
      'menuContent': {
        templateUrl: 'templates/rastreos.html',
        // controller: 'PlaylistsCtrl'
      }
    }
  })
